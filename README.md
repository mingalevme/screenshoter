...
|     | wait-for-selector                 | string     | false    | Wait for the **selector** to appear in page (https://pptr.dev/api/puppeteer.page.waitforselector). Example: 'body > #my-element'.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
...
|     | wait-for-xpath                    | string     | false    | Wait for the **xpath** to appear in page (https://pptr.dev/api/puppeteer.page.waitforxpath). Example: '//*\[@id="my-element"\]/div'.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
...
|     | wait-for-function                 | string     | false    | Waits for a function to finish evaluating in the page's context (https://pptr.dev/api/puppeteer.page.waitforfunction). Example: 'window.innerWidth < 100'.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
